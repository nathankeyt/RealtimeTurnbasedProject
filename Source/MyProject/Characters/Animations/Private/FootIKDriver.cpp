...
#include "MyProject/Characters/Animations/Public/IKDriverBase.h"
#include "MyProject/Characters/Public/BaseCharacter.h"

void UFootIKDriver::Update()
{
...
void UFootIKDriver::SetBoneGroupShouldMove(FBoneGroup& BoneGroup)
{
	if (!LegsToMoveCount)
	{
...
void UFootIKDriver::MoveLeg(FIKBoneNode& MovingLeg)
{
...
bool UFootIKDriver::DoFootTrace(FIKBoneNode& BoneNode)
{
